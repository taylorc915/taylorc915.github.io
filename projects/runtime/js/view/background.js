...
var background = function (window) {
    ...
    window.opspark.makeBackground = function(app,ground) {
        console.log('MAKEBACKGROUND FUNCTION')
        if(!app) {
        ...
        function render() {
            ...
            var moon = draw.bitmap('img/backboi.png');
            moon.x = 0;
            moon.y = 0;
            moon.scaleX = 1;
            moon.scaleY = .45;
            ...
            var building;
            for(var i=0;i<5;++i) {
            var buildingHeight = Math.floor(Math.random() * 300);
            building = draw.bitmap('img/castle.png')
            building.x = 350*i;
            building.y =  ground.y-230;
            background.addChild(building);
            buildings.push(building);
            }
            
            // TODO 4: Part 1 - Add a tree
            tree = draw.bitmap('img/spaceyboi.png');
            tree.x = canvasWidth;
            tree.y = groundY-330;
